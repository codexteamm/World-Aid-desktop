 ...
 */
public class JavamailUtilCampement {
    public static void sendMail(String recepient, String Message) throws Exception{
        System.out.println("Preparing to send:");
        Properties properties = new Properties();       
        
        String myAccountEmail ="sofien.triki1@esprit.tn";
        String password ="games12234556";
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recepient, String Messagee){
        try {
            ...
            Logger.getLogger(JavamailUtilCampement.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
}
